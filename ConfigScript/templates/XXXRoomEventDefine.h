//
//  __Prefix__RoomEventDefine.h
//  __Prefix__Room-iOS
//
//  Created by David on 2020/7/3.
//

#ifndef __Prefix__RoomEventDefine_h
#define __Prefix__RoomEventDefine_h

// 通用 UI 配置

#define k__Prefix__ContentLeftMargin  (15.0f)
#define k__Prefix__ContentRightMargin (15.0f)

#if DEBUG
#define __Prefix__Log(fmt, ...) {NSLog((@"CarRoom: [line: %d], %s, " fmt), __LINE__, __PRETTY_FUNCTION__, ##__VA_ARGS__);}
#else
#define __Prefix__Log(fmt, ...)
#endif
...
#endif /* __Prefix__RoomEventDefine_h */
